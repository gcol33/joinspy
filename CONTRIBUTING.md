...
This document provides guidelines for contributing to joinspy—its codebase and documentation.
...
joinspy uses **testthat** for testing.
...
- Test with base R, tibbles, and data.tables.
